...
$GLOBALS['TL_LANG']['tl_settings']['fzCookiesDisableCookieLevel2']   = array('Erweiterte Cookies verstecken', 'Der Bereich Erweiterte Cookies wird nicht angezeigt. Der Benutzer kann zwischen den verbleibenden Möglichkeiten wählen.');
$GLOBALS['TL_LANG']['tl_settings']['fzCookiesDisableCookieLevel3']   = array('Analyse-Cookies verstecken', 'Der Bereich Analyse-Cookies wird nicht angezeigt. Der Benutzer kann zwischen den verbleibenden Möglichkeiten wählen.');
$GLOBALS['TL_LANG']['tl_settings']['fzCookiesCookieTitle1']   = array('Erforderliche Cookies Titel', 'Titel für erforderliche Cookies');
$GLOBALS['TL_LANG']['tl_settings']['fzCookiesCookieTitle2']   = array('Erweiterte Cookies Titel', 'Titel für Erweiterte Cookies');
$GLOBALS['TL_LANG']['tl_settings']['fzCookiesCookieTitle3']   = array('Analyse-Cookies Titel', 'Titel für Analyse-Cookies');
